...
1. **Pre-processing**: Import, clean and standardize (real-world) raw data
...
The public **dataset** (27.7 MB) used for this analysis can be downloaded from: https://www.kaggle.com/datasets/valeriamaciel/e-coli-resistance-dataset/data
